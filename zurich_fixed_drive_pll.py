        ...
        while not self.should_stop():
            ...
            def amp_reset_procedure():
                ...
                if median_amp_deviation > 0:
                    drive_scale_factor = (self.target_amp) / (self.target_amp + median_amp_deviation)
                    ...
                    # suppose Q hasn't changed and k=Q/R_resonant then 
                    # 
                    self.k = self.k * (self.target_amp + median_amp_deviation) / self.target_amp
