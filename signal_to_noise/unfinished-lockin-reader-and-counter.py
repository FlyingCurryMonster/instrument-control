...
class lockin_reader(Procedure):
    ...
    counteraddr = Parameter('HP counter addr.', default = '2::3')
    

    DATA_COLUMNS = ['UTC', 'timestamp', 'f', 'X channel', 'Y channel']
    ...
    def startup(self):
        ...
        self.counter = HP_53132A('GPIB{}::INSTR'.format(self.counteraddr))
